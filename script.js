...
function setupSlider(containerSelector, dotsSelector) {
...
if (window.innerWidth <= 768) {
  setupSlider('.cards-container', '.products-dots');
  setupSlider('.second-cards-container', '.featured-dots');
  setupSlider('.gallery-grid', '.gallery-dots');
}